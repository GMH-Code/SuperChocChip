...
class Renderer(RendererBase):
    def __init__(self, scale=None, use_colour=True):
        ...
        if use_colour:
            self.colour_map = {
                0x1: 0x00E080, 0x2: 0xE04040, 0x3: 0xE0E0E0, 0x4: 0x101010,
                0x5: 0x00D070, 0x6: 0xD03030, 0x7: 0xD0D0D0, 0x8: 0x202020,
                0x9: 0x00C060, 0xA: 0xC02020, 0xB: 0xC0C0C0, 0xC: 0x303030,
                0xD: 0x00B050, 0xE: 0xB01010, 0xF: 0xB0B0B0
            }
        else:
